...
public class LlitterDBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // TODO: Create the images table... and more
    ...
    public boolean addLitter(Litter litter) {
        ...
        values.put(LITTERS_MESSAGE, litter.getTimestamp());
        values.put(LITTERS_IMAGE_ID, litter.getTimestamp());
        values.put(LITTERS_RELITTERS, litter.getTimestamp());
        values.put(LITTERS_LIKES, litter.getTimestamp());
